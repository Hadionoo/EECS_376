...
private:
    ...
    ros::NodeHandle nh_;
    actionlib::SimpleActionServer<lab_4::path_msgAction> as_;
    lab_4::path_msgGoal goal_;
    lab_4::path_msgResult result_;
    lab_4::path_msgFeedback feedback_;
...
public:
    ...
    void executeCB(const actionlib::SimpleActionServer<lab_4::path_msgAction>::GoalConstPtr& goal);
};    
...
void Lab4Server::executeCB(const actionlib::SimpleActionServer<lab_4::path_msgAction>::GoalConstPtr& goal){
