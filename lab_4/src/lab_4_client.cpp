...
void doneCb(const actionlib::SimpleClientGoalState& state, const lab_4::path_msgResultConstPtr& result){
...
int main(int argc, char** argv) {
    ros::init(argc,argv, "my_path_action_client");
        actionlib::SimpleActionClient<lab_4::path_msgAction> action_client("path_action", true);
    lab_4::path_msgGoal goal;
