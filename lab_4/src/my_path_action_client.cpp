...
void doneCb(const actionlib::SimpleClientGoalState& state, const lab_4_client::path_msgResultConstPtr& result){
...
int main(int argc, char** argv) {
    ros::init(argc,argv, "lab_4_client");
        actionlib::SimpleActionClient<lab_4_client::path_msgAction> action_client("path_action", true);
    lab_4_client::path_msgGoal goal;
